...
|CP-04: Cambio de estatus. | Verificar que el Personal pueda marcar una cita como "Completada". | Selección de cita pendiente y cambiar el estado a “Atendido". | Poder cambiar el estatus de una consulta. | Funcion Mejorable. |
...
|CP-07: Reprogramar cita. | Verificar que el paciente pueda reprogramar una cita sin la necesidad de cancelar la ya creada. | Fecha y hora. | El usuario puede cambiar la fecha y hora de su cita. | Funcion mejorable |
...
|CP-11: Visualización correcta en dispositivos móviles. | Verificar que la interfaz se adapte correctamente en resoluciones móviles. | Acceso a la URL del sistema desde navegadores y cambio de resoluciones en herramientas de desarrollador (f12). | Resultado esperado: La interfaz mantiene su estructura sin deformaciones. | inompleta |
|CP-12: Acceso al historial médico desde el dashboard del doctor. | Verificar que el médico pueda abrir el historial desde la tabla de citas. | Clic en el botón o ícono de "Historial" dentro de la fila de una cita programada en la tabla de consultas del día. | El historial del paciente se muestra correctamente. | Completa |
|CP-13: Acceso al historial médico desde el asistente. | Verificar que el asistente pueda consultar historiales médicos. | Búsqueda de un paciente por nombre o ID y selección de la opción "Consultar historial médico". | El historial se visualiza correctamente sin errores. | Completado. |
|CP-14: Registro de nueva consulta médica. | Verificar que el doctor pueda guardar información médica en el historial. | Texto en campos de diagnóstico, observaciones médicas y tratamiento en el formulario de atención. | La consulta se almacena correctamente. | Funcion mejorable. |
|CP-15: Validación de campos vacíos. | Verificar que no se permitan registros médicos incompletos. | Intento de guardar una consulta dejando los campos obligatorios (como diagnóstico) sin información. | El sistema muestra mensajes de error y evita guardar datos inválidos. | Funcion mejorable. |
|CP-16: Comprobar funciones de rol. | Verificar que cada rol acceda únicamente a las funciones permitidas. | Credenciales de acceso para los distintos perfiles: Paciente, Doctor y Asistente. | Restricción correcta según permisos. | Completado. |


## 2. Evidencia:
  * [CP-01: Verificar inicio de sesion correcto.](evidencia1.png)
  * [CP-02: Validar la creacion de una nueva cita medica.](evidencia2.png)
  * [CP-03: Evitar que se agenden dos citas a la misma hora.](evidencia3.png)
  * [CP-04: Verificar que el Personal pueda marcar una cita como "Completada".](evidencia4.png)
  * [CP-05: Validar que el paciente pueda liberar un espacio agendado.](evidencia5.png)
  * [CP-06: Verificar que se bloque la funcion de agendar una cita para el paciente que ya cuente previamente con una.](evidencia6.png)
  * [CP-07: Verificar que el paciente pueda reprogramar una cita sin la necesidad de cancelar la ya creada.](evidencia7.png)
  * [CP-08: Verificar que el Personal pueda registrar un nuevo paciente.](evidencia8.png)
  * [CP-09: Que al registrar un paciente este cuente con un perfil para iniciar sesión.](evidencia9.png)
  * [CP-10: Comprobar que el Doctor vea sus citas programadas del dia.](evidencia10.png)
  * [CP-11: Verificar que la interfaz se adapte correctamente en resoluciones moviles. ](evidencia11.png)
  * [CP-12: Verificar que el medico pueda abrir el historial desde la tabla de citas.](evidencia12.png)
  * [CP-13: Verificar que el asistente pueda consultar historiales medicos.](evidencia13.png)
  * [CP-14: Verificar que el doctor pueda guardar informacion medica en el historial.](evidencia14.png)
  * [CP-15: Verificar que no se permitan registros medicos incompletos.](evidencia15.png)
  * [CP-16: Verificar que cada rol acceda unicamente a las funciones permitidas.](evidencia16.png)


## 3. Error detectado y corrección aplicada
Se aplicaron correcciones exitosas en los siguientes puntos detectados[cite: 36, 77]:
