...
* [cite_start]**CP-01 al CP-03**: Inicio de sesión, agendado de citas y control de traslapes[cite: 2].
* [cite_start]**CP-04 al CP-07**: Gestión de estatus, cancelación y reprogramación de citas[cite: 2].
* [cite_start]**CP-08 al CP-09**: Registro de pacientes nuevos y validación de sus perfiles[cite: 2].
* [cite_start]**CP-10**: Visualización de agenda del doctor[cite: 2].
* [cite_start]**CP-11**: Adaptabilidad en dispositivos móviles[cite: 2].
* [cite_start]**CP-12 al CP-16**: Acceso a historiales médicos (Doctor/Asistente), registro de consultas y funciones de rol[cite: 2].
